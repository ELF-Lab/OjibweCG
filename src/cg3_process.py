...
def fst_parse_word(input_word:str, fst_parser:Fst) -> list[str]:
    """
    Parse an Ojibwe word using a finite-state transducer (FST) and return a list of analyses.
...
def fst_tags_to_cg3_reading(fst_analysis: str) -> str:
    ...
    Examples
    --------
    >>> fst_tags_to_cg3_reading("waabam+VTA+Cnj+Pos+Neu+1SgSubj+3SgProxObj")
